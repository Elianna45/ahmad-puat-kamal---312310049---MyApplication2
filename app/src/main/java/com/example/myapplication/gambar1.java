...
public class gambar1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gambar1);  // pastikan nama layout Anda sesuai
        ...
        searchBar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(gambar1.this, search.class);
    ...
    private void performDownload() {
        ...
        Toast.makeText(gambar1.this, "Download started", Toast.LENGTH_SHORT).show();
    }
