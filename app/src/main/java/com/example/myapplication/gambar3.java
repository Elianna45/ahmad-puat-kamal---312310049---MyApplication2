...
public class gambar3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gambar3);  // pastikan nama layout Anda sesuai
        ...
        searchBar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(gambar3.this, search.class);
    ...
    private void performDownload() {
        ...
        Toast.makeText(gambar3.this, "Download started", Toast.LENGTH_SHORT).show();
    }
