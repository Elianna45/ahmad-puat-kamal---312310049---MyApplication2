...
public class gambar2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gambar2);  // pastikan nama layout Anda sesuai
        ...
        searchBar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(gambar2.this, search.class);
    ...
    private void performDownload() {
        ...
        Toast.makeText(gambar2.this, "Download started", Toast.LENGTH_SHORT).show();
    }
