...
public class gambar03 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gambar03);  // pastikan nama layout Anda sesuai
        ...
        searchBar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(gambar03.this, search.class);
    ...
    private void performDownload() {
        ...
        Toast.makeText(gambar03.this, "Download started", Toast.LENGTH_SHORT).show();
    }
