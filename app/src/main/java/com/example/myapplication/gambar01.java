...
public class gambar01 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchBar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(gambar01.this, search.class);
    ...
    private void performDownload() {
        ...
        Toast.makeText(gambar01.this, "Download started", Toast.LENGTH_SHORT).show();
    }
